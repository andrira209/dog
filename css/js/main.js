...
function mainSlider() {
	...
	BasicSlider.slick({
		...
		fade: true,
		arrows: true,
		prevArrow: '<button type="button" class="slick-prev"><img src="img/icon/arrow_left.png"/*tpa=https://shibariuminu.com/js/img/icon/arrow_left.png*/ alt=""></button>',
		nextArrow: '<button type="button" class="slick-next"><img src="img/icon/arrow_right.png"/*tpa=https://shibariuminu.com/js/img/icon/arrow_right.png*/ alt=""></button>',
		responsive: [
